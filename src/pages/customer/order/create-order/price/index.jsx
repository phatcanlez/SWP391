            ...
            <Card>
              <Radio value="option1">
                <Space>
                  ...
                  <div>
                    <span style={{ fontWeight: 'bold' }}>Economical Delivery</span>
                    <br />
                    <span style={{ color: 'rgba(0, 0, 0, 0.45)' }}>Expected delivery within 2 days</span>
                  </div>
                </Space>
              </Radio>
            ...
            <Card>
              <Radio value="option2">
                <Space>
                  ...
                  <div>
                    <span style={{ fontWeight: 'bold' }}>Standard Delivery</span>
                    <br />
                    <span style={{ color: 'rgba(0, 0, 0, 0.45)' }}>Expected delivery within 2 days</span>
                  </div>
                </Space>
